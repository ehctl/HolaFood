...
export const OrderPageHeader = React.memo((props: OrderPageHeader) => {
    ...
    return (
        <View
            style={{
                ...
                paddingTop: 5, height: OrderPageHeaderStat.HEADER_MAX_HEIGHT
            }}>

            <TransparentView style={{ justifyContent: 'center', alignItems: 'center', marginLeft: 5 }}>
                <TransparentText text="Order" style={{ fontSize: 22, fontWeight: '700', color: '#28b1c9' }} />
            </TransparentView>
...
export type OrderPageHeader = {
}

export const OrderPageHeaderStat = {
